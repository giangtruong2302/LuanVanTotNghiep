...
const StaffProfile = () => {
  ...
  const staffId = location.pathname.split("/")[3];
  console.log("check cus id: ", staffId);
  useEffect(() => {
    //  CARD CUSTOMER PROFILE API
    handleGetDetailStaff(staffId)
      .then((res) => {
        const data = res.staffDetail;
                ...
                <Row className={classes.infoCustomer}>
                  <Col span={10} className={classes.infoLeft}>
                    ...
                    <div className={classes.nameInfo}>
                      {customerProfile ? customerProfile?.StaffName : "Loading"}
                    </div>
                  </Col>
