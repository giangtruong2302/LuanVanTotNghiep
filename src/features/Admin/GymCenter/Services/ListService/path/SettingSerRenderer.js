...
import { handleDeleteService } from "../../ModalService/ModalServiceAPI";
const { confirm } = Modal;

const SettingSerRenderer = (props) => {
  ...
  console.log("check show popover: ", props);
  return (
    <>
      <Popover
        content={content}
...
export default SettingSerRenderer;
